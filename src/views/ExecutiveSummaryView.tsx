      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-card rounded-lg border p-5">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie data={pillarCounts} cx="50%" cy="50%" innerRadius={60} outerRadius={95} paddingAngle={3} dataKey="value" label={({ name, percent }) => <text style={{ fontSize: '9px', fontWeight: 500 }}>{`${name} ${(percent * 100).toFixed(0)}%`}</text>}>
